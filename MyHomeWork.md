...
В терминале команда **git pull** – подтягивает данные из удаленного репозитория.
...
Git push  --set – upstream origin (название побочной ветки)

(В удаленном репозитории создается побочная ветка)
